  ...
  render() {
    return (
      <React.Fragment>
        ...
        <Modal visible={this.state.modal4State} onClickBackdrop={this.toggleModal4}
          dialogClassName="modal-lg" 
          title="모달4 제목1"
          body="컴포넌트로 분리하기 ~~">

            {/* <div className="modal-header">
              <h5 className="modal-title">모달4 제목</h5>
              <button type="button" className="close" onClick={this.toggleModal4}>
                <span aria-hidden="true">&times;</span>
              </button>
					  </div> */}

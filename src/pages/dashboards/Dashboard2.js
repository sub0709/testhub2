...
class Dashboard2 extends Component {
  ...
  makeIcx() {
    return <span data-plugin="counterup">{this.state.tmainInfo.icxCirculationy}</span>
  }
        ...
        <Row>
          <Col>
            <div className="page-title-box">
              <Row>
                <Col lg={7}>
                  <h4 className="page-title">Welcome, {this.state.displayName} {this.state.displayName2}</h4>
                </Col>
            ...
            <div className="widget-rounded-circle card-box">
              <div className="row">
                ...
                <div className="col-6">
                  <div className="text-right">
                    <h3 className="text-dark mt-1">
                      <span data-plugin="counterup">{Math.floor(this.state.tmainInfo.icxSupply / 100000)}</span>
                    </h3>
                  ...
                  <tbody>
                    {
                      this.state.list.map( (item) => {
                        ...
                        <td style={{ width: "36px" }}>{item.amount}
                        </td>
